...
Welcome to ``geomcompare`` contributor's guide.
...
If you experience bugs or general issues with ``geomcompare``, please have a look
...
You can help improve ``geomcompare`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``geomcompare`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``geomcompare``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/geomcompare.git
    cd geomcompare
...
#. Install |pre-commit|_::
   ...
   ``geomcompare`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/geomcompare
.. _issue tracker: https://github.com/<USERNAME>/geomcompare/issues
.. <-- end -->
